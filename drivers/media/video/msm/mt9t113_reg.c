...
static const struct mt9t113_i2c_reg_conf const mt9t113_config1[] = {
...
//delay 200ms
static const struct mt9t113_i2c_reg_conf const mt9t113_config3[] = {
	{0x3400, 0x7a28},	// ivan
//	{0x3400, 0x7a2c},	// ivan
	...
	{0x098E, 0x3C44}, 	// MCU_ADDRESS
	{0x0990, 0x0000}, 	// MCU_DATA_0
//	{0x0018, 0x002A}, 	// STANDBY_CONTROL_AND_STATUS //ivan 
};


//Set below register at Stream start function
static const struct mt9t113_i2c_reg_conf const mt9t113_STANDBY_CONTROL_AND_STATUS[] = {
	{0x0018, 0x002A}, 	// STANDBY_CONTROL_AND_STATUS //ivan
};

//delay = 150
static const struct mt9t113_i2c_reg_conf const mt9t113_config4[] = {
...
//  POLL  SEQ_CMD =>  0x00
//delay = 300 , 
static const struct mt9t113_i2c_reg_conf const mt9t113_config5[] = {
//ivan
#if 0
	{0x098E, 0x6848},            // MCU_ADDRESS
	{0x0990, 0x003F},            // MCU_DATA_0
	{0x098E, 0x6865},            // MCU_ADDRESS
	{0x0990, 0x801F},            // MCU_DATA_0
	{0x098E, 0x6867},            // MCU_ADDRESS
	{0x0990, 0x12F7},            // MCU_DATA_0
	{0x098E, 0x6881},            // MCU_ADDRESS
	{0x0990, 0x0002},            // MCU_DATA_0
	{0x098E, 0x6883},            // MCU_ADDRESS
	{0x0990, 0x000B},            // MCU_DATA_0
	{0x098E, 0x8400},            // MCU_ADDRESS
	{0x0990, 0x0006},            // MCU_DATA_0
#endif
...
static const struct mt9t113_i2c_reg_conf const mt9t113_config_preview[] = {
...
static const struct mt9t113_i2c_reg_conf const mt9t113_config_capture[] = {
	{0x098E, 0xEC09},  // MCU_ADDRESS [PRI_B_NUM_OF_FRAMES_RUN]
	{0x0990, 0x0000},  // MCU_DATA_0
	{0x098E, 0x8400},  // MCU_ADDRESS [SEQ_CMD]
	{0x0990, 0x0002},  // MCU_DATA_0
...
struct mt9t113_reg mt9t113_regs = {
	.config1 = 	&mt9t113_config1[0],
	.config1_size = ARRAY_SIZE(mt9t113_config1),
	.config2 = 	&mt9t113_config2[0],
	.config2_size = ARRAY_SIZE(mt9t113_config2),
	.config3 =	&mt9t113_config3[0],
	.config3_size = ARRAY_SIZE(mt9t113_config3),
	.config4 = 	&mt9t113_config4[0],
	.config4_size = ARRAY_SIZE(mt9t113_config4),
#if 0
	.config5 = 	&mt9t113_config5[0],
	.config5_size = ARRAY_SIZE(mt9t113_config5),
#endif
	.preview = 	&mt9t113_config_preview[0],
	.preview_size = ARRAY_SIZE(mt9t113_config_preview),
	.capture = 	&mt9t113_config_capture[0],
	.capture_size = ARRAY_SIZE(mt9t113_config_capture),
};
