...
#
# $Id: compvers.sh 241914 2011-02-20 03:11:27Z prakashd $
#
...
# path that COMPONENT_DIR_<component>
COMPONENT_QUERY_router=src
...
do
	...
	tag=$(python $GETCOMPVER_PATH $MERGERLOG $abs_path 2> $NULL)
