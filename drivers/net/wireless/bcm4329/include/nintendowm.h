 ...
 *
 *
 * $Id: nintendowm.h,v 13.9 2008-12-01 21:56:49 nvalji Exp $
 */
...
/* XXX: */
#if 0
#define NWM_GET_SCANRESULTS_CFM_MINSIZE		(CalcCfmMsgLength(nwm_get_scanresults_cfm_t))
#endif
...
typedef BWL_PRE_PACKED_STRUCT struct {
	uint16				wlRsv[NWM_RSV];
	nwm_cmdhdr_t		header;
} BWL_POST_PACKED_STRUCT nwm_hdr_top_t;
#endif
...
/* Test signal request */
/* XXX: Waiting for Nintendo approval */
typedef BWL_PRE_PACKED_STRUCT struct {
	uint16				wlRsv[NWM_RSV];
	nwm_cmdhdr_t		header;
...
/* IOPOS related items */
#if defined (LINUX) || defined (TARGETENV_linux)
#define NWM_SIOCDEVPRIVATE		(SIOCDEVPRIVATE)
#else
#define NWM_SIOCDEVPRIVATE	(1)
#endif /* LINUX || TARGETENV_linux */
