 ...
 *
 * $Id: hndrte_osl.h,v 13.98.4.5 2011-01-26 20:40:29 eichang Exp $
 */
...
#define PKTSETNODROP(osh, lb)	lb_setnodrop(LBP(lb))
#define PKTNODROP(osh, lb)		lb_nodrop(LBP(lb))

#define PKTSETTYPEEVENT(osh, lb)	lb_settypeevent(LBP(lb))
#define PKTTYPEEVENT(osh, lb)		lb_typeevent(LBP(lb))

#define PKT_SET_DOT3(osh, lb)	lb_set_dot3_pkt(LBP(lb))
#define PKT_DOT3(osh, lb)		lb_dot3_pkt(LBP(lb))
