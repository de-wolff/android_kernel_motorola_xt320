 ...
 *
 * $Id: i2s_core.h,v 13.1 2009-11-02 19:23:57 jaredh Exp $
 */
 ...
 * 0 means 16-bit (default)
 * 1 means 20-bit
 * 2 means 24-bit
 * 3 means 32-bit
 */
#define I2S_DC_WL_TX_SHIFT		(10)
#define I2S_DC_WL_TX_MASK		(0x3<<I2S_DC_WL_TX_SHIFT)
#define I2S_DC_WL_RX_SHIFT		(12)
#define I2S_DC_WL_RX_MASK		(0x3<<I2S_DC_WL_RX_SHIFT)
...
static const struct _i2s_clkdiv_coeffs i2s_clkdiv_coeffs[] = {
	...
	/* 12.288MHz */
	{12288000,	8000,	536,	0x6}, /* Can we use 6 <-> 16 for 1536 fs ? */
...
#define I2S_STXC_WL_MASK	(0x3<<I2S_STXC_WL_SHIFT)
