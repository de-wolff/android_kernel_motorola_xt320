 ...
 *
 * $Id: d11.h,v 13.535.2.39 2011-02-02 22:45:14 gpasrija Exp $
 */
...
#ifdef WLNINTENDO
#define	TX_NITRO_FIFO		TX_ATIM_FIFO	/* ATIM FIFO is used for Nintendo Nitro frames */
#endif
...
#define	MCTL_PHYLOCK		(1 << 21)  /* PR41476 WAR: Prevent phyreg access collision */
...
#ifdef WLNINTENDO
/* Residual pollbitmap from a MP sequence in frmtxstatus2 */
#define TXS_POLLBITMAP_MASK	0xffff0000
#define TXS_POLLBITMAP_SHIFT	16
#endif
...
#define	XFC_SP			(1 << 8)	/* suspend pending XXX-did this change? */
...
#define	XFC4_SP			(1 << 9)	/* suspend pending XXX-did this change? */
...
BWL_PRE_PACKED_STRUCT struct d11txh {
	...
	uint16	MaxAggDurLen;			/* 0x29 corerev >=16 */
	uint16	MaxRNum_lenFBR;			/* 0x2a corerev >=16 */
...
/* XXX: although 12 mic keys are supported, each dest can have 2 keys pending same time */
...
#ifdef WLNINTENDO
/* QNULL template area is used as MPACK template in Nitro mode */
#define T_MPACK_TPL_BASE	T_QNULL_TPL_BASE
#endif
...
#ifdef WLNINTENDO
#define M_SSID_MASK		(0x37c * 2) /* 32 byte ssid mask applied to probe req */
#endif
...
/* Synthpu WAR - see PR 19544, PR 56301 */
...
/* nrate table */
#define M_NRATE_TBL_PTR         (0x56 * 2)
#define M_NRATE_STF_OFFSET       6
...
#define M_SSLPNPHYREGS_PTR	(M_PSM_SOFT_REGS + (71 * 2))
...
/* SW PR 38178 : SHM offset to save IQ comp coeffs */
/* for 20-in-40 Tx IQ Comp WAR PR 37101            */
...
#define M_AFEOVR_PTR		(0x2c*2)	/* XXX adress tone jammer WAR block */
#define M_IFSCTL1		(0x2d*2)	/* XXX address of stored default ifs_ctl1 value */
...
#define MHF1_IQSWAP_WAR		0x0200		/* SW PR 38178: WAR for HW PR 37101 */
...
#define MHF2_SYNTHPUWAR		0x0004		/* PR19544,force VCO recal when powerup synthpu */
...
#define MHF2_NPHY40MHZ_WAR	0x0800		/* PR37123 WAR: nphy "chanest" */
...
#define MHF3_NPHY_MLADV_WAR	0x0010		/* PR 37122 WAR for bcm4321A0/A1 */
...
#define MHF3_BTCX_DELL_WAR	0x0080		/* PR 50943 WAR */
...
#define MHF3_PR45960_WAR	0x0800		/* LPPHY PR45960 WAR */
...
#define MHF5_BTCX_AUX_SHARED	0x0020		/* BT uses AUX antenna */
...
#ifdef WLNINTENDO
/* Status of Keydata response for the received MP frame */
#define RXS_KEYDATA_MASK	0xc000
#define RXS_KEYDATA_TX		0x4000
#define RXS_KEYDATA_EMPTY	0x8000
#define RXS_KEYDATA_NOTXOP	0xc000
#endif
...
/* BTCX constants */
#define M_BTCX_CONFIG_43236_SWCTRLOVRD 0x0001
...
#ifdef WLNINTENDO
/* Nitro mode share memory block constant define */
#define M_NITRO_BLK	0x36c
#define M_NITRO_AID	((M_NITRO_BLK + 0) * 2)		/* Child AID */
#define M_MPACK_PCTL	((M_NITRO_BLK + 1) * 2)
#define M_MPACK_DUR	((M_NITRO_BLK + 2) * 2)		/* MPACK packet duration */
#define M_NITRO_NULLDUR	((M_NITRO_BLK + 3) * 2)		/* MP NULL packet duration */
#define M_MP_RA0	((M_NITRO_BLK + 4) * 2)		/* store MPSEQ multicast address */
#define M_MPKEY_RA0	((M_NITRO_BLK + 7) * 2)		/* store MPKEY multicast address */
#define M_MPACK_RA0	((M_NITRO_BLK + 10) * 2)	/* store MPACK multicast address */
#endif
...
typedef struct macstat {
	...
	uint16	rxnack;			/* XXX 0xee afterburner: received nacks */
	uint16	frmscons;		/* XXX 0xf0 afterburner: frames consumed waiting requeue */
	uint16	txnack;			/* XXX 0xf2 afterburner: transmitted nacks */
	uint16	txglitch_nack;		/* XXX 0xf4 afterburner: subset of above */
...
#define WOWL_TX_FIFO_TXRAM_BASE	(0x628 * 2)	/* XXX conservative, leave 1KB for GTKM2 */
